...
date > .cachebust 
docker build -t dmilan/utak-docker-spark . --build-arg SPARK_VERSION=${SPARK_VERSION}  --build-arg LIVY_VERSION=${LIVY_VERSION} -f Dockerfile.debian
# docker build -t dmilan/utak-docker-spark . --build-arg SPARK_VERSION=${SPARK_VERSION}  --build-arg LIVY_VERSION=${LIVY_VERSION} -f Dockerfile.alpine
